  ...
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['custom:copywriting:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['custom:copywriting:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['custom:copywriting:export']"
        >导出</el-button>
      </el-col>
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width" width="180">
        <template slot-scope="scope">
          <el-button
            ...
            v-hasPermi="['custom:copywriting:edit']"
          >修改</el-button>
          <el-button
            size="mini"
            type="text"
    ...
    <el-dialog :title="title" :visible.sync="open" width="600px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="文案内容" prop="content">
          <el-input v-model="form.content" type="textarea" :rows="5" placeholder="请输入文案内容" />
        </el-form-item>
      </el-form>
...
<script>
import { listCopywriting, getCopywriting, delCopywriting, addCopywriting, updateCopywriting } from "@/api/custom/copywriting";
...
export default {
  ...
  methods: {
    ...
    handleUpdate(row) {
      ...
      getCopywriting(id).then(response => {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('custom/copywriting/export', {
        ...this.queryParams
