<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="deptList" @selection-change="handleSelectionChange">
      ...
      <!-- <el-table-column label="科室编号" align="center" prop="postId" /> -->
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="科室顺序" prop="postSort">
...
<script>
import { listPost, getPost, delPost, addPost, updatePost } from "@/api/his/dept";
