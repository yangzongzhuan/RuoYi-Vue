...
public class CozeGZHWorkFlow {
    ...
    private static CozeWorkflowClient.JsonResponse submitAsyncRequest(JsonNode parameters, String token) throws IOException {
        ...
        try {
            ...
            try (OutputStream os = conn.getOutputStream()) {
                JsonNode requestBody = mapper.createObjectNode()
                        .put("workflow_id", "7496867429113905179")
                        .put("is_async", true)
    ...
    private static void validateResponse(CozeWorkflowClient.JsonResponse response) throws Exception {
    ...
    private static CozeWorkflowClient.JsonResponse parseResponse(HttpURLConnection conn) throws IOException {
