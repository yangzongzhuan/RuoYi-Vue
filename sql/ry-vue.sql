...
CREATE TABLE `psd_task`  (
  ...
  `username` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '作图账号名称',
...
-- ----------------------------
INSERT INTO `psd_template` VALUES (1, '{\"基础配置\":{\"模板名称\":\"正文靠左 三个字 无姓氏\",\"做图账号名称\":\"liuxianying\",\"psd本地路径\":\"C:\\\\Users\\\\liuxianying\\\\Desktop\\\\qm\\\\A4xin.psd\",\"图片保存路径\":\"C:\\\\output\"},\"图片配置\":[{\"图片所在文件夹名称\":\"正文靠左 三个字 无姓氏\",\"是否有子文件夹\":true,\"子文件夹名称\":\"4\",\"文字图层配置\":{\"文字图层1\":{\"名称\":\"远之\",\"原文示例\":\"测试1\",\"每行最大字符数\":3},\"文字图层2\":{\"名称\":\"杨本身是一种树木，拆解为木易二字，结合姓氏字形，音律都为上佳，也有祝福孩子茁壮成长为参天大树，顺风顺水之意。 \",\"原文示例\":\"测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试\",\"每行最大字符数\":15,\"提示词\":\"测试1\"}},\"要修改的文字图层数量\":2,\"提示词\":\"测试1\"},{\"图片所在文件夹名称\":\"正文靠左 三个字 小名\",\"是否有子文件夹\":true,\"子文件夹名称\":\"4\",\"文字图层配置\":{\"文字图层1\":{\"名称\":\"林星然\",\"原文示例\":\"测试2\",\"每行最大字符数\":5},\"文字图层2\":{\"名称\":\"出自宋代诗人孔武仲的《奉祠城西夜坐苑中即事》“乔林翳明星，林缺星粲然” [小名]：然然、小星星\",\"原文示例\":\"杨本身是一种树木发生的力量的撒肯定撒里卡多雷克萨打开了立刻大师傅零点三零\",\"每行最大字符数\":15,\"提示词\":\"测试2\"}},\"要修改的文字图层数量\":2,\"提示词\":\"测试2\"}]}');
...
INSERT INTO `sys_menu` VALUES (2002, 'psd任务创建', 3, 300, 'task', 'custom/task/index', NULL, '', 1, 0, 'C', '0', '0', 'psd:task:list', '#', 'admin', '2025-03-12 17:14:21', '', NULL, '【请填写功能名称】菜单');
INSERT INTO `sys_menu` VALUES (2003, 'psd任务查询', NULL, 1, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'psd:task:query', '#', 'admin', '2025-03-12 17:15:23', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2004, 'psd任务新增', NULL, 2, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'psd:task:add', '#', 'admin', '2025-03-12 17:15:23', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2005, 'psd任务修改', NULL, 3, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'psd:task:edit', '#', 'admin', '2025-03-12 17:15:23', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2006, 'psd任务删除', NULL, 4, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'psd:task:remove', '#', 'admin', '2025-03-12 17:15:23', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2007, 'psd任务导出', NULL, 5, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'psd:task:export', '#', 'admin', '2025-03-12 17:15:23', '', NULL, '');
