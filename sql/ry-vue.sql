...
-- Records of psd_task
-- ----------------------------
INSERT INTO `psd_task` VALUES (6, '我', 'liuxianying', '正文靠左 三个字 无姓氏', NULL, NULL);
INSERT INTO `psd_task` VALUES (7, '测试', 'liuxianying', '正文靠左 三个字 无姓氏', NULL, NULL);
INSERT INTO `psd_task` VALUES (8, '测试', 'liuxianying', '正文靠左 三个字 无姓氏', NULL, NULL);
INSERT INTO `psd_task` VALUES (9, '达瓦达瓦', 'liuxianying', '正文靠左 三个字 无姓氏', NULL, NULL);
INSERT INTO `psd_task` VALUES (10, '测试', 'liuxianying', '正文靠左 三个字 无姓氏', NULL, NULL);
INSERT INTO `psd_task` VALUES (11, 'dw', 'liuxianying', '正文靠左 三个字 无姓氏', NULL, NULL);
INSERT INTO `psd_task` VALUES (12, 'dwa', '测试', '测试', NULL, NULL);
INSERT INTO `psd_task` VALUES (13, '测试', '测试', '测试', NULL, NULL);
INSERT INTO `psd_task` VALUES (14, 'dw', 'liuxianying', '正文靠左 三个字 无姓氏', NULL, NULL);
INSERT INTO `psd_task` VALUES (15, 'dw', 'liuxianying', '正文靠左 三个字 无姓氏', NULL, NULL);
INSERT INTO `psd_task` VALUES (16, 'dw', 'liuxianying', '正文靠左 三个字 无姓氏', NULL, NULL);
INSERT INTO `psd_task` VALUES (17, 'dwa', 'liuxianying', '正文靠左 三个字 无姓氏', NULL, NULL);
INSERT INTO `psd_task` VALUES (18, 'dwwa', 'liuxianying', '正文靠左 三个字 无姓氏', NULL, NULL);
INSERT INTO `psd_task` VALUES (19, 'dwadw', 'liuxianying', '正文靠左 三个字 无姓氏', NULL, NULL);
INSERT INTO `psd_task` VALUES (20, '无敌', '测试', '测试', NULL, NULL);
INSERT INTO `psd_task` VALUES (21, 'dwdw', '测试', '测试', NULL, NULL);
INSERT INTO `psd_task` VALUES (22, 'dw', 'liuxianying', '正文靠左 三个字 无姓氏', NULL, NULL);
INSERT INTO `psd_task` VALUES (23, 'wdw', 'liuxianying', '正文靠左 三个字 无姓氏', NULL, NULL);
...
-- ----------------------------
INSERT INTO `psd_template` VALUES (1, '{\"baseConfig\":{\"templateName\":\"正文靠左 三个字 无姓氏\",\"accountName\":\"liuxianying\",\"psdLocalPath\":\"C:\\\\Users\\\\liuxianying\\\\Desktop\\\\qm\\\\A4xin.psd\",\"imageSavePath\":\"C:\\\\output\"},\"imageConfigs\":[{\"folderName\":\"正文靠左 三个字 无姓氏\",\"hasSubfolder\":true,\"subfolderName\":\"4\",\"textLayerConfigs\":{\"textLayer1\":{\"name\":\"远之\",\"sampleText\":\"远之\",\"maxCharsPerLine\":3},\"textLayer2\":{\"name\":\"杨本身是一种树木，拆解为木易二字，结合姓氏字形，音律都为上佳，也有祝福孩子茁壮成长为参天大树，顺风顺水之意。 \",\"sampleText\":\"杨本身是一种树木，拆解为木易二字，结合姓氏字形，音律都为上佳，也有祝福孩子茁壮成长为参天大树，顺风顺水之意。 \",\"maxCharsPerLine\":15}},\"prompt\":\"给我生成女孩名字，textLayer1 是名字， textLayer2是名字描述\"},{\"folderName\":\"正文靠左 三个字 小名\",\"hasSubfolder\":true,\"subfolderName\":\"4\",\"textLayerConfigs\":{\"textLayer1\":{\"name\":\"林星然\",\"sampleText\":\"林星然\",\"maxCharsPerLine\":5},\"textLayer2\":{\"name\":\"出自宋代诗人孔武仲的《奉祠城西夜坐苑中即事》“乔林翳明星，林缺星粲然” [小名]：然然、小星星\",\"sampleText\":\"出自宋代诗人孔武仲的《奉祠城西夜坐苑中即事》“乔林翳明星，林缺星粲然” [小名]：然然、小星星\",\"maxCharsPerLine\":15}},\"prompt\":\"给我生成男孩名字，textLayer1 是名字， textLayer2是名字描述\"}]}');
INSERT INTO `psd_template` VALUES (2, '{\"baseConfig\":{\"templateName\":\"测试\",\"accountName\":\"测试\",\"psdLocalPath\":\"C:\\\\Users\\\\liuxianying\\\\Desktop\\\\qm\\\\A4xin.psd\",\"imageSavePath\":\"C:\\\\output\"},\"imageConfigs\":[{\"folderName\":\"正文靠左 三个字 无姓氏\",\"hasSubfolder\":true,\"subfolderName\":\"4\",\"textLayerConfigs\":{\"textLayer1\":{\"name\":\"远之\",\"sampleText\":\"测试1\",\"maxCharsPerLine\":3,\"prompt\":\"\"},\"textLayer2\":{\"name\":\"杨本身是一种树木，拆解为木易二字，结合姓氏字形，音律都为上佳，也有祝福孩子茁壮成长为参天大树，顺风顺水之意。 \",\"sampleText\":\"测试哇达瓦达瓦梵蒂冈梵蒂冈梵蒂冈反对广泛的\",\"maxCharsPerLine\":15,\"prompt\":null}},\"prompt\":\"测试\"}]}');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 103, 'admin', '若依', '00', 'ry@163.com', '15888888888', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', '2025-03-11 23:09:34', 'admin', '2025-03-08 23:02:42', '', '2025-03-11 23:09:34', '管理员');
